...
// Static imports as primary data source (English + Bengali)
import localGuidesData_en from '@/data/public_guides.json';
import localIndexData_en from '@/data/public_guides_index.json';
import localGuidesData_bn from '@/data/public_guides_bn.json';
...
/**
 * Switch the active guide dataset language.
 * Called by LanguageContext when language changes.
 */
export function setGuidesLanguage(lang: 'en' | 'bn'): void {
