...
import { setGuidesLanguage } from '@/lib/guidesStore';
...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'footer.disclaimer.text': 'Unofficial guide — verify on official portals before acting.',
    'footer.version': 'INFOBASE — Bangladesh Government Services Knowledge Base',
    'footer.tagline': 'Built for citizens of Bangladesh',
  },
  bn: {
    // Navigation
    'nav.home': 'হোম',
    ...
    'footer.disclaimer.text': 'অনানুষ্ঠানিক গাইড — পদক্ষেপ নেওয়ার আগে অফিসিয়াল পোর্টালে যাচাই করুন।',
    'footer.version': 'INFOBASE — বাংলাদেশ সরকারি সেবা জ্ঞানভাণ্ডার',
    'footer.tagline': 'বাংলাদেশের নাগরিকদের জন্য তৈরি',
  },
};
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  const [language, setLanguageState] = useState<Language>(() => {
    ...
    // Initialize guides store with saved language
